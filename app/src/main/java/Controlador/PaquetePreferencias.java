 ...
 */
public class PaquetePreferencias implements Paquete, Serializable {
    ...
    public PaquetePreferencias(String ip, int port, boolean wait, ArrayList<String> phones, ArrayList<String> sms, ArrayList<String> kw) {
        this.ip = ip;
        this.port = port;
    ...
    public void parse(byte[] packet) {
        ...
        try {
            ...
            PaquetePreferencias p = (PaquetePreferencias) in.readObject();
            setIp(p.getIp());
            setPort(p.getPort());
